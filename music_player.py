...
class QtTest(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self): 
        ...
        self.listWidget.itemClicked.connect(self.MStream_play_func) #列表绑定函数
        self.btn_2.clicked.connect(self.MStream_play_func)
        self.btn_3.clicked.connect(self.MStream_off_func)
